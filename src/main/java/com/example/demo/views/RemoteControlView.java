...
public class RemoteControlView extends VerticalLayout {
    ...
    private void createRemoteControlInterface() {
        ...
        // Command history
        commandHistoryLayout = new VerticalLayout();
    ...
    private Component createCommandGrid() {
        ...
        row1.add(
            createCommandCard("🔒 Lock Device", "Lock the device screen remotely", "LOCK", "#e74c3c"),
        ...
        row2.add(
            ...
            createCommandCard("🚨 Sound Alarm", "Play loud alarm sound", "ALARM", "#f39c12")
        );
        ...
        row3.add(
            createCommandCard("📍 Locate Device", "Request current location", "LOCATE", "#9b59b6"),
        ...
        row4.add(
            createCommandCard("🗑️ Wipe Data", "DANGEROUS: Erase all data", "WIPE", "#c0392b")
        );
    ...
    private void showWipeConfirmation() {
        ...
        Div text = new Div(new Span("⚠️ WARNING: This will PERMANENTLY erase all data on the device. This action CANNOT be undone!"));
