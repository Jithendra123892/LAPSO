...
public class AgentDownloadView extends VerticalLayout {
    ...
    private void createDownloadOptions(VerticalLayout container) {
        ...
        stepsList.add(
            ...
            createInstructionStep("4", "Complete", "Your device is now protected and trackable")
        );
    ...
    private VerticalLayout createRemoteControlInstructions() {
        ...
        H3 title = new H3("NEW: Remote Control Features");
        title.getStyle()
            .set("color", "#1e3a8a")
            .set("font-size", "20px")
            .set("font-weight", "600")
        ...
        Paragraph intro = new Paragraph("The latest agent version includes remote command polling for Lock, Screenshot, and Wipe features.");
        intro.getStyle()
            .set("color", "#1e40af")
            .set("font-size", "14px")
        ...
        featuresList.getElement().setProperty("innerHTML",
            ...
            "<li><strong>Remote Lock:</strong> Instantly lock device screen. Enhanced version disables Task Manager and sets auto-lock to 1 second.</li>" +
            "<li><strong>Screenshot:</strong> Capture screen remotely. Screenshot automatically appears in viewer dialog 32 seconds after command.</li>" +
            "<li><strong>Emergency Wipe:</strong> Remotely erase device data. Requires double confirmation (warning + type WIPE_CONFIRMED) for safety.</li>" +
            "</ul>");
        ...
        accessNote.getElement().setProperty("innerHTML",
            ...
            "<strong>How to Access:</strong> After updating your agent, open the Map view in LAPSO. Click any device marker to see Lock, Screenshot, and Wipe buttons. Commands are executed when the agent polls the server (every 30 seconds).</p>");
    ...
    private VerticalLayout createUninstallSection() {
        ...
        section.add(uninstallTitle, uninstallDesc, winUninstall, macUninstall, linuxUninstall, uninstallNote);
        return section;
    }
